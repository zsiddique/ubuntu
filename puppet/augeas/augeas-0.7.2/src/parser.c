...
{
       0,   167,   167,   170,   173,   175,   180,   185,   190,   196,
     200,   202,   205,   207,   211,   216,   218,   220,   223,   225,
     227,   230,   232,   235,   237,   240,   242,   245,   247,   249,
     251,   253,   255,   258,   260,   263,   265,   267,   270,   272,
     274,   276,   279,   282,   284,   287,   289,   291,   294,   296,
     299,   301,   303,   305,   308,   310,   313,   318,   320,   324,
     328,   330
};
#endif
...
#line 55 "parser.y"
{
  ...
  yylloc.filename     = augl_get_extra(scanner)->filename;
  yylloc.error        = augl_get_extra(scanner)->error;
}
